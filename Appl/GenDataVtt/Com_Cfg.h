...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define ComConf_ComSignal_sig_DoorLock_Out                          0
#define ComConf_ComSignal_sig_LeftHAngle_Out                        1
#define ComConf_ComSignal_sig_LeftLightLength_Out                   2
#define ComConf_ComSignal_sig_RightHAngle_Out                       3
#define ComConf_ComSignal_sig_RightLightLength_Out                  4
/**\} */
...
/** 
  ...
  \{
*/ 
#define Com_GetAllSigCntOfPCConfig()                                  10UL
