 ...
 *
 *   Description:  Application header file for SW-C <CtSaFrontlight>
 *********************************************************************************************************************/
...
# ifndef RTE_CORE
typedef P2CONST(struct Rte_CDS_CtSaFrontlight, TYPEDEF, RTE_CONST) Rte_Instance; /* PRQA S 0850 */ /* MD_MSR_19.8 */
# endif
...
FUNC(void, CtSaFrontlight_CODE) RCtSaFrontlight(P2CONST(struct Rte_CDS_CtSaFrontlight, AUTOMATIC, RTE_CONST) self); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
