 ...
 * Symbol: RCtSaAmbientLightRead_doc
 *********************************************************************************************************************/
 ...
 * Symbol: RCtSaAmbientLightRead
 *********************************************************************************************************************/
    uint8 currentAmbientLight;

    (Std_ReturnType)Rte_Read_PpAmbientLightIn_DeAmbientLight(&currentAmbientLight);
    (Std_ReturnType)Rte_Write_PpAmbientLightOut_DeAmbientLight(currentAmbientLight);
